...
class ScoreScreen():
    ...
    def draw_all(self, display):
        wave_text = self.font.render(f"Wave score: {self.wave_score}" , True, (255, 255, 255))
        health_text = self.font.render(f"Health score: {self.health_score}" , True, (255, 255, 255))
        money_text = self.font.render(f"Money score: {self.money_score}" , True, (255, 255, 255))
        total_text = self.font.render(f"Total score: {self.total_score}" , True, (255, 255, 255))
